...
<Library LVVersion="13008000">
	...
	<Item Name="Array in place.vi" Type="VI" URL="../Array in place.vi"/>
	<Item Name="benchmark sequence structure.vi" Type="VI" URL="../benchmark sequence structure.vi"/>
	<Item Name="CLFN.vi" Type="VI" URL="../CLFN.vi"/>
	<Item Name="cluster in place.vi" Type="VI" URL="../cluster in place.vi"/>
	<Item Name="DVR unwrapper.vi" Type="VI" URL="../DVR unwrapper.vi"/>
	<Item Name="error case.vi" Type="VI" URL="../error case.vi"/>
	<Item Name="load asynchronous call.vi" Type="VI" URL="../load asynchronous call.vi"/>
</Library>
